        ...
        <View style={styles.section}>
          ...
          <View style={styles.cargoSummary}>
            ...
            <View style={styles.cargoSummaryItem}>
              ...
              <Text style={styles.cargoSummaryText}>{(parseFloat(cargoWeight) * parseFloat(cargoItems)).toFixed(2)} kg</Text>
            </View>
            
            <View style={styles.cargoSummaryItem}>
              <Box size={16} color={colors.gray} />
              <Text style={styles.cargoSummaryText}>{(cargoVolume * parseFloat(cargoItems)).toFixed(2)} m³</Text>
            </View>
            
            <View style={styles.cargoSummaryItem}>
              <Ruler size={16} color={colors.gray} />
              <Text style={styles.cargoSummaryText}>
                {cargoLength} × {cargoWidth} × {cargoHeight} cm * {cargoItems} items
              </Text>
            </View>
        ...
        <View style={styles.section}>
          <View style={styles.priceContainer}>
            ...
            <Text style={styles.priceBreakdown}>
              Base price + distance ({distanceKm} km) + approach ({selectedVehicle.approachDistance} km) + weight ({(parseFloat(cargoWeight) * parseFloat(cargoItems)).toFixed(2)} kg) + volume ({(cargoVolume * parseFloat(cargoItems)).toFixed(2)} m³)
          ...
          <View style={styles.orderSummary}>
            ...
            <View style={styles.orderSummaryItem}>
              ...
              <Text style={styles.orderSummaryValue}>{(parseFloat(cargoWeight) * parseFloat(cargoItems)).toFixed(2)} kg</Text>
            </View>
            
            <View style={styles.orderSummaryItem}>
              <Text style={styles.orderSummaryLabel}>Volume</Text>
              <Text style={styles.orderSummaryValue}>{(cargoVolume * parseFloat(cargoItems)).toFixed(2)} m³</Text>
            </View>
