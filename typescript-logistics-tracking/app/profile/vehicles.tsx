...
import { VehicleType, User, Currency, Vehicle } from '@/types';
...
export default function VehiclesScreen() {
  ...
  const { fetchOrders, fetchOrders2, newVehicleData, updateVehicleData, isLoading } = useOrderStore();
  ...
  const calculateTestPrice = () => {
    ...
    const handleAddVehicle = async () => {
      ...
      try {
        ...
        */
        const response = await newVehicleData(user.id, newVehicle);
