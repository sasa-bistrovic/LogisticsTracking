...
public class OrderService {
    ...
    public Order createOrder(Order orderData) {
        ...
        statusUpdate.setNote("Order created with status: pending");
        ...
        statusUpdate2.setStatus("created");
        statusUpdate2.setTimestamp(java.time.LocalDateTime.now().toString());
        statusUpdate2.setNote("Order automatically created with price: " + orderData.getPrice() + " " + orderData.getCurrency());
